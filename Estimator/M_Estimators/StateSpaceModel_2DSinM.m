function StateSpaceModelN = StateSpaceModel_2DSinM(StateSpaceModelN)
    ...
    % 函数句柄
    StateSpaceModelN.StateTransitionEquation = @(In_State, StateSpaceModelN) StateSpaceModel_2DSinMStateTransitionFunction(In_State, StateSpaceModelN);
    StateSpaceModelN.ObservationEquation = @(In_State, StateSpaceModelN) StateSpaceModel_2DSinMObservationFunction(In_State, StateSpaceModelN);
    StateSpaceModelN.PredictionEquation = @(In_State, StateSpaceModelN) StateSpaceModel_2DSinMPredictionFunction(In_State, StateSpaceModelN);
    StateSpaceModelN.EstimatorPort = @(StateSpaceModelN) StateSpaceModel_2DSinMEstimatorPort(StateSpaceModelN);
    StateSpaceModelN.EstimatorPortTermination = @(StateSpaceModelN) StateSpaceModel_2DSinMEstimatorPortTermination();
end

function [Out_State, StateSpaceModelN] = StateSpaceModel_2DSinMStateTransitionFunction(In_State, StateSpaceModelN)
    % 状态: [x; vx; phix; y; vy; phiy]
...
function [Out_Observation, StateSpaceModelN] = StateSpaceModel_2DSinMObservationFunction(In_State, StateSpaceModelN)
    % 观测: z = [x; y]
    Out_Observation = StateSpaceModelN.Matrix_H * In_State;
end
function [Out_PredictedState, StateSpaceModelN] = StateSpaceModel_2DSinMPredictionFunction(In_State, StateSpaceModelN)
    ...
    if StateSpaceModelN.PredictStep
        for k = 1:StateSpaceModelN.PredictStep
            [Out_PredictedState, StateSpaceModelN] = ...
                StateSpaceModel_2DSinMStateTransitionFunction(Out_PredictedState, StateSpaceModelN);
        end
    end
end

function StateSpaceModelN = StateSpaceModel_2DSinMEstimatorPort(StateSpaceModelN)
    StateSpaceModelN = Estimator3002(StateSpaceModelN);
end

function StateSpaceModel_2DSinMEstimatorPortTermination(StateSpaceModelN)
