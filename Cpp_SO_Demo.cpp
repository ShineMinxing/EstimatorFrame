...
int main() {
    ...
    // 3) Resolve symbols
    auto StateSpaceModel1_Initialization =
        reinterpret_cast<EP_Initialization_Type>(dlsym(handle, "StateSpaceModel1_Initialization"));
    auto StateSpaceModel1_EstimatorPort =
        reinterpret_cast<EP_EstimatorPort_Type>(dlsym(handle, "StateSpaceModel1_EstimatorPort"));
    auto StateSpaceModel1_EstimatorPortTermination =
        reinterpret_cast<EP_Termination_Type>(dlsym(handle, "StateSpaceModel1_EstimatorPortTermination"));

    const char* err = dlerror();
    if (err || !StateSpaceModel1_Initialization || !StateSpaceModel1_EstimatorPort || !StateSpaceModel1_EstimatorPortTermination) {
